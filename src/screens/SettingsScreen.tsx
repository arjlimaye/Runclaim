...
export default function SettingsScreen({ navigation, onShowOnboarding }: { navigation: any; onShowOnboarding?: () => void }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          <TouchableOpacity style={styles.row} onPress={onShowOnboarding}>
            <Text style={styles.rowLabel}>How does RunClaim work?</Text>
            <Text style={styles.rowArrow}>→</Text>
          </TouchableOpacity>
        </View>
      </View>
